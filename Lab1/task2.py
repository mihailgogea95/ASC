...
print "Numer of words : "  + str(len(content.split()))

print "Open Parantheses " + str(content.count("("))

print "Number apparition of Python " + str(content.count("Python")) 

print "Last 10 characters " + content[-10:] 
